...
从数据存储的角度来说，爱企查站内的已有数据多类似三元组的结构，即 主体id + 数据维度 + dataid 的形式，因此从数据存储结构的迁移和处理上，知识图谱的灌库成本更小。
...
![img](/Users/wangjian63/develop/spikewong.github.io/_posts/assets/imageDownloadAddress-20250123200902883.png)
